...
export Mesh, make_mesh, relax_mesh!, grid_uniform_triangles, rejection_method, find_bars

"""
    Mesh{T, S}

Mesh with nodes of dimension `S` and element type `T`
...
function Mesh(
    ...
    nodes = hcat(fixed_nodes, nodes)  # add in fixed nodes
